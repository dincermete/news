...
@section('content')
    <div class="mx-auto max-w-md px-4 py-16 sm:px-6">
        <div class="rounded-[20px] border border-ink/10 bg-paper p-6 sm:p-8">
            <h1 class="font-display text-2xl font-medium text-ink">Giriş yap</h1>
            <p class="mt-1.5 text-sm text-ink-2">Hesabınıza erişmek için giriş yapın.</p>
            ...
            <a href="{{ route('auth.google.redirect') }}" class="mt-6 flex w-full items-center justify-center gap-x-2.5 rounded-2xl border border-ink/10 bg-white px-4 py-3 text-sm font-semibold text-ink transition hover:bg-ink/5 active:scale-[0.98]">
            ...
            <p class="mt-5 text-center text-sm text-ink-2">
                Hesabınız yok mu?
                <a href="{{ route('register') }}" class="font-semibold text-accent-700 hover:text-accent-800">Kayıt ol</a>
            </p>
        </div>
    </div>
@endsection
