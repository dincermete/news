...
<div class="overflow-x-auto" x-data="siteTable()">
    <table
        x-ref="table"
        class="site-catalog-table w-full min-w-0 text-start sm:min-w-[980px]"
    ...
    >
        <thead>
            <tr class="site-catalog-table__head">
                ...
                <th class="{{ $thMetric }} hidden sm:table-cell">
                ...
                <th class="site-catalog-table__th relative hidden whitespace-nowrap px-4 py-3.5 pe-7 text-end align-bottom text-[11px] font-semibold uppercase tracking-wide text-ink sm:table-cell">
                ...
                <th class="site-catalog-table__th hidden whitespace-nowrap px-4 py-3.5 text-end align-bottom text-[11px] font-semibold uppercase tracking-wide text-ink sm:table-cell">İşlem</th>
            </tr>
            ...
            >
                ...
                >
                    <td class="site-catalog-table__td sticky start-0 z-10 min-w-[220px] bg-white px-5 py-3.5 transition group-hover:bg-paper">
                        <a href="{{ storefront_site_url($site) }}" class="flex min-w-0 items-center gap-x-3" @click.stop>
                    ...
                    <td class="{{ $tdMetric }} hidden sm:table-cell">
                    ...
                    <td class="site-catalog-table__td hidden whitespace-nowrap px-4 py-3.5 text-end sm:table-cell">
                        @if ($hasDiscount)
                    ...
                    <td class="site-catalog-table__td hidden whitespace-nowrap px-4 py-3.5 sm:table-cell">
                        <div class="flex items-center justify-end gap-1.5">
                            <div @click.stop>
                                <x-visit-site-button :site="$site" compact class="border-ink/10 text-ink-2 hover:border-ink/25 hover:text-ink" />
                            </div>
